...
const Hero = () => {
  ...
  <p className= {`${styles.paragraph} max-w-[470px] mt-5 ` }>
    ...
    methodology to identify the credit cards most likely to fit your needs. We examine annual percentage rates, annual fees.
  </p>
</div>

{/* Robot hand img and gradients */}
...
<div className='absolute z-[0] top-0 w-[50%] h-[50%] blue__gradient bottom-20 right-20'/>
